...
public class convertLeadToOppurtunitytc_26  extends BaseClass{
	...
	public void leadToOppurtunity() throws Throwable {
		...
		/*Test  Data*/
		String leadName = elib.getExcelData("Contact", "tc_26", "FirstName");
		String listName = elib.getExcelData("Contact", "tc_26", "listName");
		String Page = elib.getExcelData("Contact", "tc_26", "Page");
