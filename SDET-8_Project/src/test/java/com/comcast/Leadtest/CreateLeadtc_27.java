...
public class CreateLeadtc_27 extends BaseClass {

	@Test (priority=5, groups={"SmokeTest"})
	public void createLead() throws Throwable {

		/*Test  Data*/
		String Salutation= elib.getExcelData("Contact", "tc_27" , "salutation") ;
		String FirstName = elib.getExcelData("Contact", "tc_27" , "FirstName") ;
		String LastName = elib.getExcelData("Contact",  "tc_27" , "LastName") ;
		String Company = elib.getExcelData("Contact",   "tc_27" , "Company") ;
		String Industry = elib.getExcelData("Contact", "tc_27" , "Industry");
		String Email = elib.getExcelData("Contact", "tc_27", "Email");
